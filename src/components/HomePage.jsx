...
//         <div style={{ ...styles.ticket, ...styles.blueTicket }} />
//         <div style={{ ...styles.ticket, ...styles.greenTicket }} />
//         <div style={{ ...styles.ticket, ...styles.purpleTicket }} />
//       </div>
...
//         <h1 style={styles.title}>Welcome to QuickShow</h1>
//         <p style={styles.subtitle}>
//           Book your favorite movie tickets with ease. Select your show, choose your seats, and enjoy the experience!
//         </p>
//         <button style={styles.ctaButton} onClick={() => navigate("/movies")}>
