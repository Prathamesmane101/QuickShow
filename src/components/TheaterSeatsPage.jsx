...
//   return (
//     <div style={{ padding: "2rem", fontFamily: "Arial, sans-serif", backgroundColor: "#111", color: "#fff" }}>
//       <h2 style={{ textAlign: "center" }}>🎭 Theater: {theaterName}</h2>
//       <h3 style={{ textAlign: "center", marginTop: "1rem", fontSize: "1.2rem" }}>Select your seat</h3>
...
//             transform: `translateX(${(rowIndex - 6) * 5}px)` // subtle curve effect
//           }}>
//             {cols.map((col) => {
//               const seat = `${row}${col}`;
//               return (
...
//                   style={{
//                     padding: "0.6rem",
//                     backgroundColor: selectedSeats.includes(seat) ? "#28a745" : "#222",
//                     color: "#fff",
...
//       {/* Selected Seats and Confirm Button */}
...
//             gap: "0.5rem",
//             justifyContent: "center",
//             transform: `translateX(${(rowIndex - 6) * 5}px)`
//           }}>
//             {cols.map((col) => {
//               const seat = `${row}${col}`;
//               return (
...
//           {rows.map((row, rowIndex) => (
//             <div key={row} style={{ ...styles.row, transform: `translateX(${(rowIndex - 6) * 5}px)` }}>
//               {cols.map((col) => {
//                 const seat = `${row}${col}`;
//                 return (
//                   <button
...
//         // Optionally redirect or store payment info
//       },
//       prefill: {
//         name: userName,
...
//       const ticketAmount = selectedSeats.length * 250; // ₹250 per seat
